        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
               ...
               <div class="grid grid-cols-5 space-x-4">
                    <div v-for="category in categoriesWithCount" class="bg-blue-600 h-32 w-54 shadow-xl rounded-lg border border-gray-100 flex justify-center p-4 grid bg-blue-800 text-white">
